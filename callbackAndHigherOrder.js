...
const multiply = (numOne, numTwo, cb) => {
...
// CODE HERE
each(names, (item, i) => console.log(`The item at index ${item} is ${i}`))
...
/*
  ...
  the variable add[NUMBER] with the name of the number
  you chose.
